...
def processState(state1):
    """
    This method reshapes state into [21168]
    Args:
        1.state1(ndarray):
        state as input data
    Returns:
        1.reshaped array into [21168]
    """
    return np.reshape(state1,[21168])
    
def updateTargetGraph(tfVars,tau):
    """
    This method allows you to update parameters of your target network,\n
    ...
    Returns:
        1.op_holder(list):
        values which are used to update target network
    """
...
def updateTarget(op_holder,sess):
    """
    This method updates target network to sync with main network\n
    Args:
        1.op_holder(list):
        values which are used to update target network
        1.sess(Session):
